 ...
 */
export type QueryKeyPart = QueryKeyPrimitive | QueryKeyRecord | readonly QueryKeyPart[];
 ...
 */
export type BlocksQueryKey<TParts extends readonly QueryKeyPart[] = readonly QueryKeyPart[]> =
  TParts & {
 ...
 */
export type QueryKeyBuilder<TPrefix extends readonly QueryKeyPart[] = readonly QueryKeyPart[]> = <
 ...
 */
export type QueryClientKitFilters<TFilters extends QueryFilters = QueryFilters> = Omit<
  TFilters,
  "queryKey"
>;
 ...
 */
export type QueryClientKitInvalidateFilters = QueryClientKitFilters<InvalidateQueryFilters>;

/**
 * Refetch filters accepted by `refetch`.
 */
export type QueryClientKitRefetchFilters = QueryClientKitFilters<RefetchQueryFilters>;
...
> = Omit<FetchQueryOptions<TQueryFnData, TError, TData, TQueryKey>, "queryKey" | "queryFn">;
