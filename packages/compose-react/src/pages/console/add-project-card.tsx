...
export const AddProjectCard = () => {
  ...
  return (
    <Card
      onClick={handleClick}
      className={cn(
        "border-primary/30 hover:border-primary/70 flex h-40 items-center justify-center rounded-2xl border bg-transparent shadow-sm transition-all duration-200 hover:shadow-md md:py-4",
