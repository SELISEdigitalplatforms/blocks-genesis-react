...
export function SidebarMenuDesktop({
  ...
  return (
    <div
      className={`hidden h-screen shrink-0 flex-col overflow-hidden border-r bg-background transition-[width] duration-300 ease-in-out md:flex ${isSidebarOpen ? "w-60" : "w-14"}`}
    >
