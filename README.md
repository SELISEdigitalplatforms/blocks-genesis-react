...
- [packages/compose-react](./packages/compose-react): React composition package with shadcn-based components and app-shell utilities (published as `@seliseblocks/blocks-kit`)
